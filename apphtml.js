...
//            }
        ...
        'primaryGenreId', 'isGameCenterEnabled', 'wrapperType', 'artworkUrl512',
        'artworkUrl512', 'artistViewUrl', 'contentAdvisoryRating', 'trackCensoredName',
        ...
        *********** iTunes Search APIの戻り値（ここまで）***********/
        ...
        w.result = function (data) {
            ...
            try {
                //artworkUrl512がないものをresultsから削除
                //2015/11/8 緊急パッチ。仕様変更の見極めが必要なためコメントアウトにとどめる。
                //for (var i = 0; i < data.results.length; i++) {
                //    if (!data.results[i].artworkUrl512) {
    ...
    function handData(data) {
        ...
        if (knd == "song") {
            ...
            x.icon60url = data.artworkUrl512;
